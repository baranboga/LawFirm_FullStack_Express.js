...
exports.post_blog_edit = async function(req, res) {
    ...
    const altbaslik = req.body.altbaslik;
    const aciklama = req.body.aciklama;
    const kategoriIds = req.body.categories;     //Name attr sinden kategorilerin id lerini alırız
    ...
    try {
        ...
        if(blog) {
            ...
            if(kategoriIds == undefined) {                    //herhangi bir kategori seçilmemiş ise
...
exports.get_blogs = async function(req, res) {           //burada kal!!
    try {
